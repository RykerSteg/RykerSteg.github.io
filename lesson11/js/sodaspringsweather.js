const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=6cb6efbc5628616ae948fd81c0a5bd69';
fetch(apiURL)
...
const forecast = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=6cb6efbc5628616ae948fd81c0a5bd69';
fetch(forecast)
    .then((response) => response.json())
    .then((jsObject) => {
        console.log(jsObject);
